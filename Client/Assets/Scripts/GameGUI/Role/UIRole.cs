...
public class UIRole : GTWindow
{
    ...
    private void OnEnterGameClick(GameObject go)
    {
        ...
        if(c == null)
        {
            GTItemHelper.ShowTip("Você ainda não criou este personagem");
            return;
        }
    ...
    private void ShowView()
    {
        ...
        labHeroName.text = role != null ? GTTools.Format("Lv.{0} {1}", role.Level, role.Name != null ? role.Name : actorDB.Name) : "Não criado";
    }
