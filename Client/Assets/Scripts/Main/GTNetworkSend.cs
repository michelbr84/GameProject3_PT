...
public class GTNetworkSend : GTSingleton<GTNetworkSend>
{
    ...
    public void TryCreateRole(string name, int carrerID, ulong accountID)
    {
        ...
        {
            GTItemHelper.ShowTip("O nome do personagem não pode estar vazio");
            return;
        }
    ...
    public void TryUpgradePet(int id, List<XItem> items)
    {
        ...
        {
            GTItemHelper.ShowTip("Falta comida");
            return;
        }
        for (int i = 0; i < items.Count; i++)
        {
            ...
            {
                GTItemHelper.ShowTip("Erro na lista de alimentos");
                return;
            }
        }
        ...
        if (data != null)
        {
            ...
            if (data.Level >= count)
            {
                GTItemHelper.ShowTip("Nível do pet está no máximo");
                return;
            }
        }
    ...
    public void TryBattlePet(int id)
    {
        ...
        if (role.PetID == id)
        {
            GTItemHelper.ShowTip("Seu parceiro já está em batalha");
            return;
        }
    ...
    public void TryUnloadPet(int id)
    {
        ...
        if (role.PetID != id)
        {
            GTItemHelper.ShowTip("Você não tem esse parceiro em batalha");
            return;
        }
    ...
    public void TryUseItemByPos(int pos, int num)
    {
        ...
        if (item.Num < num)
        {
            GTItemHelper.ShowTip("Itens insuficientes");
            return;
        }
        ...
        if (itemDB.ItemType == EItemType.BOX)
        {
            if (itemDB.Data1 != 0)
            {
                ...
                {
                    GTItemHelper.ShowTip("Precisa de chaves suficientes");
                    return;
                }
            }
    ...
    public void TryStrengthEquip(XEquip equip, List<XItem> list)
    {
        if (list.Count == 0)
        {
            GTItemHelper.ShowTip("Por favor adicione equipamento ou cristal");
            return;
        }
    ...
    public void TryAdvanceEquip(XEquip equip)
    {
        ...
        {
            GTItemHelper.ShowTip("Nível avançado máximo atingido");
            return;
        }
        ...
        if (db.CostEquipNum > 0)
        {
            ...
            {
                GTItemHelper.ShowTip("Falta equipamento igual");
                return;
            }
    ...
    public void TryUpStarEquip(XEquip equip)
    {
        ...
        {
            GTItemHelper.ShowTip("Nível de estrela do equipamento máximo");
            return;
        }
    ...
    public void TryStrengthGem(XGem gem, List<XItem> list)
    {
        ...
        {
            GTItemHelper.ShowTip("Nível de fortalecimento da gema máximo");
            return;
        }
        if (list.Count == 0)
        {
            GTItemHelper.ShowTip("Por favor adicione material de upgrade");
            return;
        }
    ...
    public void TryChargeRelics(int relicsID, int index)
    {
        ...
        if (db == null)
        {
            GTItemHelper.ShowTip("Item inválido");
            return;
        }
        if (index > 3 || index < 1)
        {
            GTItemHelper.ShowTip("Índice inválido" + index.ToString());
            return;
        }
        ...
        if (relics != null)
        {
            ...
            {
                GTItemHelper.ShowTip("Você não pode mais carregar isso");
                return;
            }
        }
    ...
    public void TryUpgradeRelics(int relicsID)
    {
        ...
        {
            GTItemHelper.ShowTip("Nível máximo atingido, não pode mais evoluir");
            return;
        }
        for (int i = 0; i < 3; i++)
        {
            ...
            {
                GTItemHelper.ShowTip("Artefato não tem carga suficiente");
                return;
            }
        }
    ...
    public void TryBattleRelics(int relicsID)
    {
        ...
        {
            GTItemHelper.ShowTip("Este artefato já está em batalha");
            return;
        }
    ...
    public void TryUnloadRelics(int relicsID)
    {
        ...
        if (role.Relic != relicsID)
        {
            GTItemHelper.ShowTip("Este artefato não está em batalha, não pode ser removido");
            return;
        }
    ...
    public void TryMainCopyReceiveReward(int chapter, int index)
    {
        ...
        switch (rewardState)
        {
            case ERewardState.NOT_RECEIVE:
                GTItemHelper.ShowTip("Condição não atingida");
                return;
            case ERewardState.HAS_RECEIVE:
                GTItemHelper.ShowTip("Prêmio já recebido");
                return;
        }
